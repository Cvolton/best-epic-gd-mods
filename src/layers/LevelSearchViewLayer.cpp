...
void LevelSearchViewLayer::optimizeSearchObject() {
    ...
    */
    ...
    //if(m_searchObj.featured) m_gjSearchObjOptimized->m_bFeaturedFilter = true; (disabled bc of featured no star levels)
    ...
    if(m_searchObj.noStar) m_gjSearchObjOptimized->m_bNoStarFilter = true;
    //TODO: song filters
