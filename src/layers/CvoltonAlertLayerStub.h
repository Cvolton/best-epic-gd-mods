...
public:
	...
	gd::CCMenuItemSpriteExtra* createButton(const char* texture, cocos2d::CCPoint position, cocos2d::SEL_MenuHandler callback, float textureScale = 1.0f, float sizeMult = 1.2f);
	virtual void onClose(cocos2d::CCObject* sender) = 0;
	void keyBackClicked();
};